<?php
/**
 * Install script for customer account deletion table
 */

$installer = $this;
$installer->startSetup();

$tableName = $installer->getTable('customer_account_deletion');
...
$sql = "CREATE TABLE IF NOT EXISTS `{$tableName}` (
    ...
    CONSTRAINT `CUSTOMER_ACCOUNT_DELETION_CUSTOMER_ID_CUSTOMER_ENTITY_ENTITY_ID`
        FOREIGN KEY (`customer_id`) REFERENCES `{$installer->getTable('customer_entity')}` (`entity_id`) ON DELETE CASCADE
